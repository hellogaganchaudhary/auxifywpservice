  ...
  return (
    <header className="flex h-16 items-center justify-between border-b border-slate-200 bg-white/80 px-4 text-slate-950 backdrop-blur-xl sm:px-6">
      <div>
        ...
        <p className="hidden text-xs text-slate-500 sm:block">CRM, leads, WhatsApp inbox, templates, and workspace operations.</p>
      </div>
      <div className="flex items-center gap-3">
        ...
        <div className="flex h-9 w-9 items-center justify-center rounded-full border border-emerald-200 bg-emerald-50 text-xs font-bold text-emerald-700">
